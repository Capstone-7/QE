Feature: Product feature
   ...
   Scenario: GET Detail Profile
   	Given Get call to GET Detail Profile
   	Then I receive valid HTTP response code 401
   	
   Scenario: GET Negative Detail Profile with wrong link 
   	Given Get call to GET Negative Detail Profile with wrong link
   	Then I receive valid HTTP response code 401
   
   Scenario: POST Negative Detail Profile
   	Given Post call to POST Negative Detail Profile
